...
forval ii=$i1/$i2 {
	...
	esttab m1 m2 m3 m4 using "$fname", drop(`varlist1') scalars(`scals') label mtitle("Maximal lying" "Partial lying" "Honest" "Fraction declared") wide compress nonum title(`tt') `ap' fragment  prehead(&\multicolumn{6}{c|}{\bf `tt'}&\multicolumn{2}{c}{\bf `tt'}\\ $preh) postfoot(\hline\hline) se star(* 0.10 ** 0.05 *** 0.01)
	}
